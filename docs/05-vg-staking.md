...
|----------------|-------------------------|------------------------------------------|
| Paper Hand     | +10% к доходности (1.1x)   | -                                        |
| Wooden Hand    | +25% к доходности (1.25x)  | -                                        |
| Steel Hand     | +50% к доходности (1.5x)   | Доступ к уровню Investor DAO             |
| Titanium Hand  | +75% к доходности (1.75x)  | Доступ к уровню Launchpad Master DAO     |
| Diamond Hand   | +100% к доходности (2.0x)  | Доступ к уровню Partner DAO              |
...
1. **Активация механизма**:
   ...
   - Установка параметра автореинвестирования

2. **После окончания периода стейкинга**:
   - 100% токенов автоматически реинвестируются на новый период
   - Доступно досрочное снятие всего депозита или его части
